...
#prints pokemon names only
def printPokemonName():
	limit = 1
	...
	#	time.sleep(10/1000)
		if limit == 40:
			...
			limit = 1
	main_pause = input("press enter to continue...")

##### unused functions ###############
def printPokemonType1():
	for x in range(len(pokemon)):
		print(pokemon[x][1])

def printPokemonType2():
	for x in range(len(pokemon)):
		print(pokemon[x][2])
######################################

def filtherTypes(choice):
	for x in range(len(pokemon)):
		if choice == pokemon[x][1]:
			print(pokemon[x][0]+" "+'"'+pokemon[x][1]+'"'+" "+'"'+pokemon[x][2]+'"')
			time.sleep(0.05)
...
def printAll():
	...
	for x in range(len(pokemon)):
		limit += 1
		pokemon_number += 1
		print(pokemon_number, pokemon[x][0],"->\t", pokemon[x][1],"\t->",pokemon[x][2])
		if limit >= 38:
			pause = input("\t#......press enter to continue!............#")
			print("#", "\t NAME:", "   \tTYPE1", "    \tTYPE2")
			limit = 0